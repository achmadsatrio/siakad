...
abstract class REST_Controller extends CI_Controller {
    ...
    public function raja_sms_key(){
        return '93bea0cf05087df81df17b411dc66ca2';
    }
    
    public function raja_sms_server(){
        return 'http://45.32.118.255';
    }
    
    public function kode_status_raja_sms(){
        //Sudah di rename berdasarakan kebutuhan client 
        $data[1] = 'On Process';
        $data[2] = 'Sent';
        $data[3] = 'Delivered';
        $data[4] = 'Delivered Error';
        $data[5] = 'System Failed';
        $data[6] = 'Saldo Minus/Expired';
        $data[7] = 'Reject';
        $data[8] = 'System Error';
        $data[9] = 'Duplicate message';
        $data[10] = 'Success';
        $data[20] = 'Json Post Error';
        $data[30] = 'ApiKey not register';
        $data[25] = 'Error Check Balance';
        $data[35] = 'Check Balance Limit';
        $data[40] = 'Ip address not register';
        $data[50] = 'Expired Balance';
        $data[55] = 'Maximum Data';
        $data[60] = 'Invalid Number';
        $data[70] = 'Invalid Message';
        $data[80] = 'Minimum Balance';
        $data[90] = 'System Error';
        return $data;
    }
}
